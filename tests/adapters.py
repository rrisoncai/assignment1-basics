...
def run_scaled_dot_product_attention(
    ...
    """
    # raise NotImplementedError
    from cs336_basics.scaled_dp_attn import scaled_dp_attn
    return scaled_dp_attn(Q, K, V, mask)
...
def run_multihead_self_attention(
    ...
    layer = CausalMultiheadSelfAttention(d_model=d_model, num_heads=num_heads)
    state = {
        "Q": q_proj_weight,
        "K": k_proj_weight,
        "V": v_proj_weight,
...
def run_transformer_block(
    ...
    *batch_shape, seq_len, _ = in_features.shape
...
def run_silu(in_features: Float[Tensor, " ..."]) -> Float[Tensor, " ..."]:
    ...
    """
    # raise NotImplementedError
    from cs336_basics.util_funcs import silu
...
def run_get_batch(
    ...
    """
    # raise NotImplementedError
    from cs336_basics.util_funcs import get_batch
...
def run_softmax(in_features: Float[Tensor, " ..."], dim: int) -> Float[Tensor, " ..."]:
    ...
    """
    # raise NotImplementedError
    from cs336_basics.util_funcs import softmax
...
def run_cross_entropy(
    ...
    """
    # raise NotImplementedError
    from cs336_basics.util_funcs import cross_entropy_loss
...
def run_gradient_clipping(parameters: Iterable[torch.nn.Parameter], max_l2_norm: float) -> None:
    ...
    """
    # raise NotImplementedError
    from cs336_basics.util_funcs import gradient_clipping
...
def run_get_lr_cosine_schedule(
    ...
    """
    # raise NotImplementedError
    from cs336_basics.util_funcs import learning_rate_schedule
...
def run_save_checkpoint(
    ...
    """
    # raise NotImplementedError
    from cs336_basics.util_funcs import save_checkpoint
...
def run_load_checkpoint(
    ...
    """
    # raise NotImplementedError
    from cs336_basics.util_funcs import load_checkpoint
...
def run_train_bpe(
    ...
    **kwargs,
    ...
    bpe = BPETrainer(input_path=input_path, vocab_size=vocab_size, special_tokens=special_tokens)
